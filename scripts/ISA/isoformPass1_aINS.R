...
SwitchList_1 <- isoformSwitchAnalysisPart1(
  ...
  pathToOutput = 'results/ISA/objects/aINS/',
...
save(SwitchList_1, file = "results/ISA/objects/pass1/aINS_pass1_0.1.rds")

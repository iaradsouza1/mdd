...
SwitchList_1 <- isoformSwitchAnalysisPart1(
  ...
  pathToOutput = 'results/ISA/objects/OFC/',
...
save(SwitchList_1, file = "results/ISA/objects/pass1/OFC_pass1_0.1.rds")

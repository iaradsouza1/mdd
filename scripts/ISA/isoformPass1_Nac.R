...
SwitchList_1 <- isoformSwitchAnalysisPart1(
  ...
  pathToOutput = 'results/ISA/objects/Nac/',
...
save(SwitchList_1, file = "results/ISA/objects/pass1/Nac_pass1_0.1.rds")

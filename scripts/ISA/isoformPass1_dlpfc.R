# WARNING: This script follows "Example Workflow" described in the IsoformSwitchAnalyzeR vignette, if you wish
# to do a more in-depth analysis or, rather, don't want to use default values, please read the package's vignette
...
SwitchList_1 <- isoformSwitchAnalysisPart1(
  ...
  pathToOutput = 'results/ISA/objects/dlPFC/',
...
save(SwitchList_1, file = "results/ISA/objects/pass1/dlPFC_pass1_0.1.rds")

...
ggplot(aes(x = as.numeric(x_axis), y = n, fill = type)) +
  ...
  scale_y_continuous(name = "Number of transcriptionally altered genes", limits = c(0, 400), breaks = seq(0, 400, 50), minor_breaks = F) +
...
ggsave("results/plots_paper/fig2A.pdf", height = 4, width = 7)
ggsave("results/plots_paper/fig2A.png", height = 4, width = 7)
```
